...
namespace LPush.Web
{
    ...
    /// 自定义http status处理类
    /// </summary>
    public class CustomStatusHandler : IStatusCodeHandler
    {
        private IViewRenderer viewRenderer;

        public CustomStatusHandler(IViewRenderer viewRenderer)
        {
        ...
        {
            var response = viewRenderer.RenderView(context, "Status/404"); //指定专用的cshtml文件
